...
\begin{tikzpicture}[]
\node(1) at (-1.2,1) [colored node, red node] {1}; 
\node(2) at (-1.2,-1) [colored node, red node] {2}; 
\node(3) at (1.2,1) [colored node, blue node] {3}; 
\node(4) at (1.2,-1) [colored node, blue node] {4}; 
\node (5) at (-1,0) [colored node, green node] {5}; 
\node (6) at (1, 0) [colored node, green node] {6};
